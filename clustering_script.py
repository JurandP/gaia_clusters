...
alerts_classes = alerts_classes.groupby(alerts_classes).count()
alerts_classes = alerts_classes.loc[alerts_classes > 100]
...
# print(df_results.groupby(['DBSCAN', 'Class']).count())